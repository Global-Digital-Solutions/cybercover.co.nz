    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@graph': [
          {
            '@type': 'Organization',
            '@id': 'https://www.cybercover.co.nz/#organization',
            name: 'CyberCover',
          ...
          },
          {
            ...
            '@id': 'https://www.cybercover.co.nz/#agency',
            name: 'CyberCover',
            url: 'https://www.cybercover.co.nz',
            areaServed: { '@type': 'Country', name: 'New Zealand' },
          ...
          {
            '@type': 'WebSite',
            '@id': 'https://www.cybercover.co.nz/#website',
            url: 'https://www.cybercover.co.nz',
            name: 'CyberCover.co.nz',
            description: 'Cyber insurance comparison and broker referral for NZ businesses.',
            potentialAction: { '@type': 'SearchAction', target: 'https://www.cybercover.co.nz/blog/' },
          },
          {
            '@type': 'FAQPage',
