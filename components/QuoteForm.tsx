  ...
  if (compact) {
    return (
      <form onSubmit={handleSubmit} className="space-y-3 text-slate-900">
        ...
        <input type="tel" pattern="[+]?[0-9\s\-().]{6,}" title="Please enter a valid phone number" minLength={6} name="phone" required placeholder="021 XXX XXXX" className="w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none" />
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border-2 border-teal-100 p-8 shadow-lg text-slate-900">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          ...
          <input type="tel" pattern="[+]?[0-9\s\-().]{6,}" title="Please enter a valid phone number" minLength={6} name="phone" required placeholder="021 123 4567" className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition" />
        </div>
        <div>
